        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-24 mb-20">
          ...
          <div className="space-y-8 col-span-1 md:col-span-2 lg:col-span-1">
             ...
             <p className="text-slate-500 font-medium text-sm leading-relaxed max-w-xs">
                Chidambaram's premier academy for beauty and fashion styling. Empowering women through master-level skill training.
             </p>
          ...
          <div className="space-y-6">
             ...
             <div className="flex gap-4 items-start">
                ...
                <p className="text-slate-600 font-medium text-sm">West Car Street, Chidambaram, Tamil Nadu</p>
             </div>
             <div className="flex gap-4 items-start">
                <Phone size={20} className="text-rose-500 shrink-0" />
                <p className="text-slate-600 font-medium text-sm">+91 80727 69642</p>
             </div>
             <div className="flex gap-4 items-start">
