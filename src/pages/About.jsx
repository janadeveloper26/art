          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl">
                <img
                  src={aboutImg}
                  alt="Expert Aari Embroidery training in Chidambaram"
      ...
      {[
        {
          icon: <Heart />,
          title: "Women-Centric",
          desc: "Focusing exclusively on skills that build financial independence for women.",
        },
        {
          icon: <Star />,
          title: "World Record",
        ...
        },
        {
          ...
          desc: "A supportive community of 500+ successful graduates and business owners.",
        },
      ].map((v, i) => (
        <motion.div
          key={i}
        ...
        >
          ...
          <h3
            className={`font-serif text-2xl font-bold mb-4 ${v.highlight ? "text-white" : "text-slate-900"}`}
          >
            {v.title}
          </h3>
          <p
            className={`text-sm font-medium leading-relaxed ${v.highlight ? "text-slate-400" : "text-slate-500"}`}
          >
            {v.desc}
          </p>
        </motion.div>
