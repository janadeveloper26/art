...
export default function Home() {
  ...
  const faqs = [
    {
      q: "How much are the fashion designing course fees in Chidambaram?",
      a: "Our fees are structured to be affordable yet premium. Please visit our contact page or WhatsApp us for the latest fee structure for Aari and Tailoring.",
    },
    {
      q: "Can I learn embroidery as a complete beginner?",
      a: "Absolutely! Our courses start from basics - like how to hold the needle - and move to professional bridal work. No prior experience is required.",
    },
    {
    ...
    },
    {
      ...
      a: "We have a high-quality online curriculum with HD recordings and weekly live review sessions via WhatsApp and Zoom.",
    },
    {
      q: "Are there weekend batches for working women?",
      a: "Yes, we have special weekend batches and flexible timings designed specifically for working professionals and students.",
    },
  ];
            ...
            {courses.map((c, i) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-slate-500 text-xs font-bold italic mb-4">
                    "{c.tagline}"
                  </p>
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-12">
              <div>
                <span className="text-rose-400 font-extrabold uppercase tracking-[0.4em] text-[10px] sm:text-xs block mb-4">
                ...
                <div className="mt-8 space-y-2">
                  <p className="text-rose-300/60 font-bold text-[10px] uppercase tracking-widest">
                    Affiliation No: ICVE/CDL/CHM-281
                  </p>
                  <p className="text-rose-300/60 font-bold text-[10px] uppercase tracking-widest">
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Learn from experienced female master-artisans with professional degrees.",
                  },
                  {
